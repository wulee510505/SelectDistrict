...
public class FindPlaceActivity extends AppCompatActivity implements OnClickListener, OnPageChangeListener,RadioGroup.OnCheckedChangeListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.search_place_activity_main);

		mContext = this;
		Intent intent = getIntent();
		req_Level = intent.getIntExtra(INTENT_REQ_LEVEL, REQ_LEVEL_3);
	...
	private void initView() {
		...
		tag1 = (RadioButton) findViewById(R.id.tag1);
		tag2 = (RadioButton)findViewById(R.id.tag2);
		tag3 = (RadioButton)findViewById(R.id.tag3);
